    ...
    return (
        <div className='relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl'>
            <div className='text-center flex flex-col max-w-screen-lg overflow-hidden bg-blue border rounded shadow-sm lg:flex-row sm:mx-auto'>
                ...
                <Link to ="/topic">
                <button className='px-8  block w-full mt-7 mx-3 mr-3 py-3 font-semibold rounded-lg bg-cyan-200 text-gray-800 hover:bg-cyan-400'>Go to Quiz</button>
                </Link>
